"""
MiniFASNet architecture — vendored from Silent-Face-Anti-Spoofing
(github.com/minivision-ai/Silent-Face-Anti-Spoofing, Apache-2.0), the
trained anti-spoofing backbone the spec (Section 6 / FR-6) calls for.

Copied verbatim (architecture only) so the published .pth weights load
with an exact state_dict match. Inference wrapper lives in
app/ml/silent_face.py; pretrained weights live in models/anti_spoof/.
"""
...
keep_dict = {
    ...
    '1.8M_': [32, 32, 103, 103, 64, 13, 13, 64, 13, 13, 64, 13, 13, 64, 13, 13, 64, 231, 231, 128, 231, 231, 128, 52,
